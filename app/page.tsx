...
export default function Home() {
  return (
    <main>
      ...
      <footer><div className="shell footer-top"><a className="brand light" href="#top"><span className="brand-mark">P</span><span>PEACHTREE<br/><b>CAPITAL GROUP</b></span></a><p>Thoughtful capital guidance<br/>for growing businesses.</p><div><b>Connect</b><a href="mailto:info@peachtree.capital">info@peachtree.capital</a></div></div><div className="shell footer-bottom"><span>© 2026 Peachtree Capital Group LLC</span><div><a href="/privacy">Privacy Policy</a><a href="/terms">Terms & Conditions</a><a href="/terms#sms">SMS Terms</a></div></div></footer>
    </main>
  );
}
