...
export default function Home() {
  return (
    <main>
      ...
      <section className="contact" id="contact"><div className="shell contact-grid"><div><p className="eyebrow">START A CONVERSATION</p><h2>Let’s find the right path forward.</h2><p>Tell us a little about your business. A Peachtree consultant will follow up to discuss your goals and potential next steps.</p><a href="mailto:info@peachtree.capital">info@peachtree.capital</a></div><InquiryForm /></div></section>
