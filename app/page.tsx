...
export default function Home() {
  return (
    <main>
      ...
      <footer><div className="shell footer-top" style={{ alignItems: 'flex-start', paddingTop: '65px', paddingBottom: '45px' }}><div><a className="brand light" href="#top" style={{ marginBottom: '20px' }}><span className="brand-mark">P</span><span>PEACHTREE<br/><b>CAPITAL GROUP</b></span></a><p style={{ margin: 0 }}>Thoughtful capital guidance<br/>for growing businesses.</p></div><div><b style={{ color: 'white', marginBottom: '12px', fontSize: '13px', display: 'block' }}>Address</b><p style={{ margin: 0, fontSize: '13px', color: '#b9cbc5' }}>Peachtree Capital Group LLC<br/>1 Industrial Way West, Bldg C, Ste A<br/>Eatontown, NJ 07724</p></div><div><b style={{ color: 'white', marginBottom: '12px', fontSize: '13px', display: 'block' }}>Connect</b><p style={{ margin: 0, fontSize: '13px', color: '#b9cbc5' }}>Phone: <a href="tel:3476008967">(347) 600-8967</a><br/>Email: <a href="mailto:privacy@peachtreecapital.grou">privacy@peachtreecapital.grou</a></p></div></div><div className="shell footer-bottom"><span>© 2026 Peachtree Capital Group LLC</span><div><a href="/privacy">Privacy Policy</a><a href="/terms">Terms & Conditions</a><a href="/terms#sms">SMS Terms</a></div></div></footer>
    </main>
  );
}
